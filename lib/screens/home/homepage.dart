...
const firstColor = Color.fromARGB(255, 19, 123, 180);
const secondColor = Color.fromARGB(238, 248, 240, 227);
var username = '';
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        width: 80,
                                        child: Image.asset('assets/logomogo.png'),
                                      ),
                                      SizedBox(
                                        height: 10,
                                      ),
                                      Text('Welcome to C02Track!',
                                          style: TextStyle(
                                              fontSize: 18,
                                              color: firstColor,
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        OpenContainer(
                                          closedColor: firstColor,
                                          openColor: firstColor,
                                          middleColor: firstColor,
                                          transitionDuration:
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    title: Column(
                                      children: [
                                        Text(
                                            'Recycle and earn money. Recycling collection points.',
